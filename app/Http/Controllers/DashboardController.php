...
class DashboardController extends Controller
{
    ...
    public function getMbpSiteRegional(Request $request){
        ...
        $query_mbp->where('active',1);
        if (!$debug) $query_mbp->whereNotIn('ns_id_home', [26,27]); //dummy
        $query_mbp->groupBy('status');
        ...
        $query_site_detail = DB::table('site')->select('site_id','site_name','latitude','longitude','rtpo_id','ns_id','regional','alarm','band','status','kriteria_site','site_class as class_name','is_allocated');
