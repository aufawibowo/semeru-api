...
class SiteController extends Controller
{
  ...
  public function detailReportSite(Request $request){
  ...
  public function approveReportNewLocSite(Request $request){
  ...
  public function listReportNewSitePaginate(Request $request){
